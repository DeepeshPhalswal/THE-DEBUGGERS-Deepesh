...
def find_polygon_containing_point(point, polygons):
    point = Point(point)
...
# Example polygons (name: list of (latitude, longitude) tuples)
polygons = {
    "Amazon Rainforest": [(1.0, -60.0), (2.0, -61.0), (3.0, -60.5), (2.5, -59.5)],
    "Siberian Forest": [(60.0, 100.0), (61.0, 101.0), (62.0, 99.5), (61.5, 98.5)],
    "Yellowstone": [(44.0, -111.0), (45.0, -110.5), (44.5, -109.5), (43.5, -110.0)],
    "monteverde_cloud" : [(-85.0, 10.7),(-85.4, 9.7),(-84.3, 9.5),(-82.6, 9.2),(-82.8, 9.8),(-84.2, 10.62)],
...
# Test point (latitude, longitude)
test_point = (112, 1)

# Find the polygon containing the point
result = find_polygon_containing_point(test_point, polygons)

if result:
    print(f"The point is inside: {result}")
else:
